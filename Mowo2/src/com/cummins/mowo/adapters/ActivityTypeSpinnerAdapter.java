...
public class ActivityTypeSpinnerAdapter extends ArrayAdapter<Object> {

	private Context context;
	private int textViewResourceId;
	private String[] spinnerValues;

	public ActivityTypeSpinnerAdapter(Context context, int textViewResourceId,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
		...
		View view = inflater.inflate(R.layout.fragment_activity_type_spinner_item, null);
    ...
    public View setViewValues( View v , int position) {
		...
		TextView activityName = (TextView) view.findViewById(R.id.activity_type_textview);
		
		activityName.setText(key + " " + value);
		activityName.setTag(key);
