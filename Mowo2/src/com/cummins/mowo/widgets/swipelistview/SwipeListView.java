package com.cummins.mowo.widgets.swipelistview;
    ...
    //    
	  ...
	  @Override
	    protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX, int scrollRangeY, int maxOverScrollX, int maxOverScrollY, boolean isTouchEvent)  {
		  ...
		  Log.d(TAG, "Overscrolled by is called " + super.overScrollBy(deltaX, deltaY, scrollX, scrollY, scrollRangeX, scrollRangeY, maxOverScrollX, mMaxYOverscrollDistance, isTouchEvent));
